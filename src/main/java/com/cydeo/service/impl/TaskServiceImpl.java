...
public class TaskServiceImpl implements TaskService {
    ...
    private void checkProjectExists(String projectCode) {
       ...
       if(!Objects.requireNonNull(response.getBody()).isSuccess()){ // if it is not succesfull
        throw new ProjectCheckFailedException("Project check is failed");
        }
       if (!Objects.requireNonNull(response.getBody()).getData().equals(true)) { // !true means it is false or null, this covered both
